...
void ECU_Init(void){
    ...
    Green_LED.LED_Port = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000));
    ...
    Red_LED.LED_Port = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000));
    ...
    Admin_LCD.GPIO_PORT = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00));
    ...
    User_LCD.GPIO_PORT = ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000));
    ...
    MCAL_USART_Init(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), &Enter_Gate_UART);
    ...
    MCAL_USART_Init(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), &Exit_Gate_UART);
    ...
    PIR.GPIO_PinSpeed = 2;
    MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), &PIR);
...
void Enter_Gate_Open(void) {
    ...
    LED_TurnOff(&Green_LED);
    for (int i = 0; i < 50000; i++);
    while (MCAL_GPIO_ReadPin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), 7));
    Servo1_Entry_Gate(1);
}
# 547 "Src/ecu.c"
void Exit_Gate_Open(void) {
    ...
    LED_TurnOff(&Green_LED);
    for (int i = 0; i < 50000; i++);
    while (MCAL_GPIO_ReadPin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), 1));
    Servo2_Exit_Gate(1);
}
# 577 "Src/ecu.c"
void Wrong_RFID(void) {
