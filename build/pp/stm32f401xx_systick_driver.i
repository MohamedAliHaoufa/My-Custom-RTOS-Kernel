# 0 "drivers/Src/stm32f401xx_systick_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_systick_driver.c"
# 15 "drivers/Src/stm32f401xx_systick_driver.c"
# 1 "drivers/Inc/stm32f401xx_systick_driver.h" 1
# 34 "drivers/Inc/stm32f401xx_systick_driver.h"
...
# 35 "drivers/Inc/stm32f401xx_systick_driver.h" 2
...
# 16 "drivers/Src/stm32f401xx_systick_driver.c" 2

static void (*STK_Callback)(void);
static uint8 Running_Mode;
# 33 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_Config(STK_config_t *_cfg){
    uint32 reg_copy;


    _cfg->interrupt_config &= 0x02UL;
    _cfg->clock_config &= 0x04UL;


    reg_copy = (_cfg->interrupt_config) | (_cfg->clock_config);
    ((STK_TypeDef*)0xE000E010UL)->CTRL = reg_copy;


    MCAL_STK_SetReload(_cfg->reload_value);


    if(0x02UL == _cfg->interrupt_config){
...
# 65 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_SetReload(uint32 value){

    value &= 0x00FFFFFFUL;

    ((STK_TypeDef*)0xE000E010UL)->LOAD = value;
}
# 82 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_SetCallback(void (*pfCallback)(void)){
    STK_Callback = pfCallback;
}
# 99 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_StartTimer(){

    ((STK_TypeDef*)0xE000E010UL)->VAL = 0;


    ((STK_TypeDef*)0xE000E010UL)->CTRL |= 0x01UL;
}
# 116 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_StopTimer(){

    ((STK_TypeDef*)0xE000E010UL)->CTRL &= ~(0x01UL);
}
# 132 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_Delay(uint32 delay_ticks){

    uint32 prev_reload = ((STK_TypeDef*)0xE000E010UL)->LOAD;


    uint32 prev_cfg = ((STK_TypeDef*)0xE000E010UL)->CTRL;


    ((STK_TypeDef*)0xE000E010UL)->CTRL = 0;


    ((STK_TypeDef*)0xE000E010UL)->CTRL &= (1UL << 16);


    MCAL_STK_SetReload(delay_ticks - 1);


    ((STK_TypeDef*)0xE000E010UL)->CTRL |= (1UL << 2);


    MCAL_STK_StartTimer();


    while (((((STK_TypeDef*)0xE000E010UL)->CTRL >> 16) & 0x01UL) == 0);


    MCAL_STK_StopTimer();


    ((STK_TypeDef*)0xE000E010UL)->LOAD = prev_reload;
    ((STK_TypeDef*)0xE000E010UL)->CTRL = prev_cfg;
}
# 177 "drivers/Src/stm32f401xx_systick_driver.c"
void MCAL_STK_Delay1ms(uint32 delay_ms){
    uint32 index;
    uint32 ms_delay_time = ((8000000UL / 1000UL) - 1);
