...
void task1()
{
    ...
    while (1)
    {
        Task1LED ^= 1;
        Count++;
 MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 12, 1);
...
void task2()
{
    ...
    while (1)
    {
        Task2LED ^= 1;
        Count++;
 MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 13, 1);
...
void task3()
{
    ...
    while (1)
    {
        Task3LED ^= 1;
        Count++;
 MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 14, 1);
...
void task4()
{
    ...
    while (1)
    {
        Task4LED ^= 1;
        Count++;
 MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 15, 1);
...
int main(void)
{
    ...
    Gpioled.GPIO_MODE = 1;
    Gpioled.GPIO_PinOPType = 0;
    Gpioled.GPIO_PinSpeed = 1;
    Gpioled.GPIO_PinPuPdControl = 0;

    for(int i=0;i<16;i++){
    Gpioled.GPIO_PinNumber = i;
    MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), &Gpioled);
    }

    MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 1, 1);
    MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)), (uint16) 2, 1);
    ...
    systick_cfg.interrupt_config = 0x02UL;
    systick_cfg.reload_value = 16000 - 1;
    systick_cfg.running_mode = 0x01U;
