# 0 "drivers/Src/stm32f401xx_usart_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_usart_driver.c"
# 17 "drivers/Src/stm32f401xx_usart_driver.c"
# 1 "drivers/Inc/stm32f401xx_usart_driver.h" 1
# 22 "drivers/Inc/stm32f401xx_usart_driver.h"
...
# 220 "drivers/Inc/stm32f401xx.h" 2
...
# 23 "drivers/Inc/stm32f401xx_usart_driver.h" 2
...
# 18 "drivers/Src/stm32f401xx_usart_driver.c" 2
# 36 "drivers/Src/stm32f401xx_usart_driver.c"
static USART_cfg_t Global_USART_cfg[3];
# 50 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_Init(USART_TypeDef* USARTx, USART_cfg_t* USART_cfg) {
    uint32 BRR, pclk;


    if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x08));
        Global_USART_cfg[0] = *USART_cfg;
    } else if (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)) == USARTx) {
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x09));
        Global_USART_cfg[1] = *USART_cfg;
    } else if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)) == USARTx) {
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x0A));
    ...
    BRR = (uint32)(((uint32)((uint32)(pclk/(16 * USART_cfg->BaudRate))) << 4)|((uint32)((((uint32)((25 * pclk) / (4 * USART_cfg->BaudRate)) - (uint32)((uint32)(pclk/(16 * USART_cfg->BaudRate)) * 100)) * 16) / 100)&0xF));
    USARTx->BRR = BRR;


    if (((uint32_t)(0)) != USART_cfg->IRQ_Enable) {
        USARTx->CR1 |= USART_cfg->IRQ_Enable;


        if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
            MCAL_NVIC_EnableIRQ(37);
        } else if (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)) == USARTx) {
            MCAL_NVIC_EnableIRQ(38);
        } else if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)) == USARTx) {
            MCAL_NVIC_EnableIRQ(71);
        } else {
...
# 123 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_DeInit(USART_TypeDef* USARTx) {
    if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x08));
        MCAL_NVIC_DisableIRQ(37);
    } else if (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)) == USARTx) {
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x09));
        MCAL_NVIC_DisableIRQ(38);
    } else if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)) == USARTx) {
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0A));
        MCAL_NVIC_DisableIRQ(71);
    } else {

    }
}
# 148 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_GPIO_Set_Pins(USART_TypeDef* USARTx) {
    ...
    if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
        ...
        PinCfg.GPIO_PinNumber = 9;
        PinCfg.GPIO_MODE = 2;
        PinCfg.GPIO_PinOPType = 0;
        PinCfg.GPIO_PinPuPdControl = 0;
        PinCfg.GPIO_PinSpeed = 2;
        PinCfg.GPIO_PinAltFunMode = 7;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), &PinCfg);


        PinCfg.GPIO_PinNumber = 10;
        PinCfg.GPIO_MODE = 2;
        PinCfg.GPIO_PinPuPdControl = 1;
        PinCfg.GPIO_PinSpeed = 2;
        PinCfg.GPIO_PinAltFunMode = 7;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), &PinCfg);

        if ((((uint32_t)(1UL << 9)) == Global_USART_cfg[0].HwFlowCtl) || (((uint32_t)(1UL << 8 | 1UL << 9)) == Global_USART_cfg[0].HwFlowCtl)) {

            PinCfg.GPIO_PinNumber = 11;
            PinCfg.GPIO_MODE = 2;
            PinCfg.GPIO_PinPuPdControl = 1;
            PinCfg.GPIO_PinSpeed = 2;
            PinCfg.GPIO_PinAltFunMode = 7;
        ...
        if ((((uint32_t)(1UL << 8)) == Global_USART_cfg[0].HwFlowCtl) || (((uint32_t)(1UL << 8 | 1UL << 9)) == Global_USART_cfg[0].HwFlowCtl)) {

            PinCfg.GPIO_PinNumber = 12;
            PinCfg.GPIO_MODE = 2;
            PinCfg.GPIO_PinOPType = 0;
            PinCfg.GPIO_PinPuPdControl = 0;
            PinCfg.GPIO_PinSpeed = 2;
        ...
        if ((((uint32_t)(1UL << 9)) == Global_USART_cfg[1].HwFlowCtl) || (((uint32_t)(1UL << 8 | 1UL << 9)) == Global_USART_cfg[1].HwFlowCtl)) {

            PinCfg.GPIO_PinNumber = 0;
            PinCfg.GPIO_MODE = 2;
            PinCfg.GPIO_PinPuPdControl = 1;
            PinCfg.GPIO_PinSpeed = 2;
            PinCfg.GPIO_PinAltFunMode = 7;
        ...
        if ((((uint32_t)(1UL << 8)) == Global_USART_cfg[1].HwFlowCtl) || (((uint32_t)(1UL << 8 | 1UL << 9)) == Global_USART_cfg[1].HwFlowCtl)) {

            PinCfg.GPIO_PinNumber = 1;
            PinCfg.GPIO_MODE = 2;
            PinCfg.GPIO_PinOPType = 0;
            PinCfg.GPIO_PinPuPdControl = 0;
            PinCfg.GPIO_PinSpeed = 2;
        ...
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x02));


        PinCfg.GPIO_PinNumber = 6;
        PinCfg.GPIO_MODE = 2;
        PinCfg.GPIO_PinOPType = 0;
        PinCfg.GPIO_PinPuPdControl = 0;
        PinCfg.GPIO_PinSpeed = 2;
        PinCfg.GPIO_PinAltFunMode = 8;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)), &PinCfg);


        PinCfg.GPIO_PinNumber = 7;
        PinCfg.GPIO_MODE = 2;
        PinCfg.GPIO_PinPuPdControl = 1;
        PinCfg.GPIO_PinSpeed = 2;
        PinCfg.GPIO_PinAltFunMode = 8;
...
# 270 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_SendData(USART_TypeDef* USARTx, uint16 *pTxBuffer, Polling_Mechanism PollingEn) {
    ...
    if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
        USARTx->DR = (*pTxBuffer & (Global_USART_cfg[0].Payload_Length == ((uint32_t)(1UL << 12)) ? 0x01FF : 0xFF));
    } else if (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)) == USARTx) {
        USARTx->DR = (*pTxBuffer & (Global_USART_cfg[1].Payload_Length == ((uint32_t)(1UL << 12)) ? 0x01FF : 0xFF));
    } else if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)) == USARTx) {
        USARTx->DR = (*pTxBuffer & (Global_USART_cfg[2].Payload_Length == ((uint32_t)(1UL << 12)) ? 0x01FF : 0xFF));
    } else {

    }
}
# 299 "drivers/Src/stm32f401xx_usart_driver.c"
...
# 325 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_ReceiveData(USART_TypeDef* USARTx, uint16 *pRxBuffer, Polling_Mechanism PollingEn) {
    ...
    if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)) == USARTx) {
        *pRxBuffer = (Global_USART_cfg[0].Payload_Length == ((uint32_t)(1UL << 12))) ?
                     (Global_USART_cfg[0].Parity == ((uint32_t)(0)) ? USARTx->DR : (USARTx->DR & 0xFF)) :
                     (Global_USART_cfg[0].Parity == ((uint32_t)(0)) ? (USARTx->DR & 0xFF) : (USARTx->DR & 0x7F));
    } else if (((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)) == USARTx) {
        *pRxBuffer = (Global_USART_cfg[1].Payload_Length == ((uint32_t)(1UL << 12))) ?
                     (Global_USART_cfg[1].Parity == ((uint32_t)(0)) ? USARTx->DR : (USARTx->DR & 0xFF)) :
                     (Global_USART_cfg[1].Parity == ((uint32_t)(0)) ? (USARTx->DR & 0xFF) : (USARTx->DR & 0x7F));
    } else if (((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1400)) == USARTx) {
        *pRxBuffer = (Global_USART_cfg[2].Payload_Length == ((uint32_t)(1UL << 12))) ?
                     (Global_USART_cfg[2].Parity == ((uint32_t)(0)) ? USARTx->DR : (USARTx->DR & 0xFF)) :
                     (Global_USART_cfg[2].Parity == ((uint32_t)(0)) ? (USARTx->DR & 0xFF) : (USARTx->DR & 0x7F));
    } else {

    }
}
# 360 "drivers/Src/stm32f401xx_usart_driver.c"
...
# 400 "drivers/Src/stm32f401xx_usart_driver.c"
void MCAL_USART_Wait_TC(USART_TypeDef* USARTx) {
