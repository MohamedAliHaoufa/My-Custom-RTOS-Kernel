# 0 "drivers/Src/stm32f401xx_gpio_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_gpio_driver.c"
# 15 "drivers/Src/stm32f401xx_gpio_driver.c"
...
# 16 "drivers/Src/stm32f401xx_gpio_driver.c" 2
# 30 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_Init(GPIO_TypeDef *GPIOx, GPIO_PinConfig_t *PinConfig) {
    ...
    if (PinConfig->GPIO_MODE <= 3) {
        ...
        GPIOx->MODER |= (PinConfig->GPIO_MODE << (PinNumber * 2));
    } else {

        if (PinConfig->GPIO_MODE == 4) {
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->FTSR |= (1 << PinNumber);
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->RTSR &= ~(1 << PinNumber);
        } else if (PinConfig->GPIO_MODE == 5) {
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->RTSR |= (1 << PinNumber);
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->FTSR &= ~(1 << PinNumber);
        } else if (PinConfig->GPIO_MODE == 6) {
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->FTSR |= (1 << PinNumber);
            ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->RTSR |= (1 << PinNumber);
        }
        ...
        uint16 portcode = ( (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)))?0: (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)))?1: (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800)))?2: (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00)))?3: (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)))?4:0 );
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x11));
        ((SYSCFG_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3800))->EXTICR[temp1] = (uint32)portcode << (4 * temp2);


        ((EXTI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3C00))->IMR |= (1 << PinNumber);
    }


    GPIOx->OTYPER &= ~(0x1 << PinNumber);
    GPIOx->OTYPER |= (PinConfig->GPIO_PinOPType << PinNumber);


    GPIOx->OSPEEDR &= ~(0x3 << (PinNumber * 2));
    GPIOx->OSPEEDR |= (PinConfig->GPIO_PinSpeed << (PinNumber * 2));


    GPIOx->PUPDR &= ~(0x3 << (PinNumber * 2));
    GPIOx->PUPDR |= (PinConfig->GPIO_PinPuPdControl << (PinNumber * 2));


    if (PinConfig->GPIO_MODE == 2) {
        if (PinNumber < 8) {
            GPIOx->AFR[0] &= ~(0xF << (PinNumber * 4));
            GPIOx->AFR[0] |= (PinConfig->GPIO_PinAltFunMode << (PinNumber * 4));
        } else {
            GPIOx->AFR[1] &= ~(0xF << ((PinNumber - 8) * 4));
            GPIOx->AFR[1] |= (PinConfig->GPIO_PinAltFunMode << ((PinNumber - 8) * 4));
        }
    }
}
# 96 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_DeInit(GPIO_TypeDef *GPIOx) {
    if (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000))) {
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR |= (1 << 0);
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR &= ~(1 << 0);
    } else if (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400))) {
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR |= (1 << 1);
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR &= ~(1 << 1);
    } else if (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0800))) {
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR |= (1 << 2);
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR &= ~(1 << 2);
    } else if (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0C00))) {
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR |= (1 << 3);
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR &= ~(1 << 3);
    } else if (GPIOx == ((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000))) {
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR |= (1 << 4);
        ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->AHB1RSTR &= ~(1 << 4);
    }
}
# 127 "drivers/Src/stm32f401xx_gpio_driver.c"
uint8 MCAL_GPIO_ReadPin(GPIO_TypeDef *GPIOx, uint16 PinNumber) {
    uint8_t value;
    value = (uint8_t)(((GPIOx->IDR) >> PinNumber) & 0x00000001);
    return value;
}
# 144 "drivers/Src/stm32f401xx_gpio_driver.c"
uint16 MCAL_GPIO_ReadPort(GPIO_TypeDef *GPIOx) {
    uint16 port_value = (uint16)GPIOx->IDR;
    return port_value;
}
# 162 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_WritePin(GPIO_TypeDef *GPIOx, uint16 PinNumber, uint8 Value) {
    if (Value != 0) {
...
# 182 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_WritePort(GPIO_TypeDef *GPIOx, uint16 Value) {
    GPIOx->ODR = (uint32)Value;
}
# 198 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_TogglePin(GPIO_TypeDef *GPIOx, uint16 PinNumber) {
    GPIOx->ODR ^= (1 << PinNumber);
}
# 213 "drivers/Src/stm32f401xx_gpio_driver.c"
void MCAL_GPIO_TogglePort(GPIO_TypeDef *GPIOx){
 GPIOx->ODR ^= (uint32)((0xFFFF)<<0);
}
# 237 "drivers/Src/stm32f401xx_gpio_driver.c"
uint8 MCAL_GPIO_LockPin(GPIO_TypeDef *GPIOx, uint16 PinNumber) {
