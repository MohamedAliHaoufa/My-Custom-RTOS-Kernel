...
# 16 "bsp/Src/eeprom_flash.c" 2


uint8_t buffer[256];
# 33 "bsp/Src/eeprom_flash.c"
void EEPROM_Init(void)
{
    ...
    I2C1CFG.General_Call_Address_Detection = ((uint16_t)0x0040);
    I2C1CFG.I2C_Ack_Conrtol = ((uint16_t)0x0400);
    I2C1CFG.I2C_Speed = (100000UL);
    I2C1CFG.I2C_Mode = 0;
    I2C1CFG.P_Slave_Event_CallBack = 
# 45 "bsp/Src/eeprom_flash.c" 3 4
                                    ((void *)0)
# 45 "bsp/Src/eeprom_flash.c"
                                        ;
    I2C1CFG.I2C_stretchmode = 0x00000000U;

    MCAL_I2C_Set_GPIO(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)));
    MCAL_I2C_Init(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), &I2C1CFG);
}
# 63 "bsp/Src/eeprom_flash.c"
unsigned char EEPROM_Write_NBytes(unsigned int Memory_address, unsigned char* bytes, uint8_t Data_Length)
{
    uint8_t i;
    ...
    MCAL_I2C_Master_Tx(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x50, buffer, Data_Length + 2, WithStop, Start);

    return 0;
}
# 91 "bsp/Src/eeprom_flash.c"
unsigned char EEPROM_Read_byte(unsigned int Memory_address, uint8_t *dataout, uint8_t datalen)
{
    buffer[0] = (uint8_t)(Memory_address >> 8);
    buffer[1] = (uint8_t)(Memory_address);

    MCAL_I2C_Master_Tx(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x50, buffer, 2, WithoutStop, Start);
    MCAL_I2C_Master_Rx(((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)), 0x50, dataout, datalen, WithStop, Repeated);
