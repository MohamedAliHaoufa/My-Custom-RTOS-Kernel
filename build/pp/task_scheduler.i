# 0 "RTOS/Src/task_scheduler.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "RTOS/Src/task_scheduler.c"
# 15 "RTOS/Src/task_scheduler.c"
# 1 "RTOS/Inc/task_scheduler.h" 1
# 18 "RTOS/Inc/task_scheduler.h"
# 1 "RTOS/Inc/cortex_mx_os_porting.h" 1
# 18 "RTOS/Inc/cortex_mx_os_porting.h"
...
# 41 "CMSIS/Inc/core_cm4.h" 2
# 19 "RTOS/Inc/cortex_mx_os_porting.h" 2
# 1 "RTOS/Inc/task_scheduler.h" 1
# 20 "RTOS/Inc/cortex_mx_os_porting.h" 2

extern int _estack ;
extern int _eheap ;
# 44 "RTOS/Inc/cortex_mx_os_porting.h"
void trigger_OS_PendSV();
void Start_Ticker();
void HW_init();
# 19 "RTOS/Inc/task_scheduler.h" 2
...
# 16 "RTOS/Src/task_scheduler.c" 2
# 1 "RTOS/Inc/rtos_fifo_queue.h" 1
# 18 "RTOS/Inc/rtos_fifo_queue.h"
# 1 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 1 3
# 29 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 3
...
# 30 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 2 3
...
# 36 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 2 3
# 1 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/lib/gcc/arm-none-eabi/12.3.1/include/stddef.h" 1 3 4
...
# 60 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 3
...
extern int _fwalk_sglue (struct _reent *, int (*)(struct _reent *, __FILE *),
    struct _glue *);
# 61 "/opt/st/stm32cubeclt_1.16.0/GNU-tools-for-STM32/arm-none-eabi/include/stdio.h" 2 3
...
# 19 "RTOS/Inc/rtos_fifo_queue.h" 2





# 23 "RTOS/Inc/rtos_fifo_queue.h"
typedef struct{
...
Buffer_status FIFO_init (FIFO_Buf_t* fifo,Task_ref** buff , unsigned int length);
Buffer_status FIFO_enqueue (FIFO_Buf_t* fifo,Task_ref* item);
Buffer_status FIFO_dequeue (FIFO_Buf_t* fifo,Task_ref** item);
Buffer_status FIFO_is_full (FIFO_Buf_t* fifo);
void FIFO_print (FIFO_Buf_t* fifo);
# 17 "RTOS/Src/task_scheduler.c" 2
...
# 18 "RTOS/Src/task_scheduler.c" 2


# 19 "RTOS/Src/task_scheduler.c"
struct {
...
void MHxRTOS_OS_SVC_Set(SVC_ID ID);

FIFO_Buf_t Ready_QUEUE ;

Task_ref* Ready_QUEUE_FIFO[100] ;
Task_ref MHxRTOS_idleTask ;
# 56 "RTOS/Src/task_scheduler.c"
__attribute ((naked)) void PendSV_Handler()
{
 ...
 __asm volatile("mrs r0,PSP \n\t mov %0,r0" : "=r" (OS_Control.CurrentTask->Current_PSP) );
...
# 90 "RTOS/Src/task_scheduler.c"
 if (OS_Control.NextTask != 
# 90 "RTOS/Src/task_scheduler.c" 3 4
                           ((void *)0)
# 90 "RTOS/Src/task_scheduler.c"
                               ){
 OS_Control.CurrentTask = OS_Control.NextTask ;
 OS_Control.NextTask = 
# 92 "RTOS/Src/task_scheduler.c" 3 4
                      ((void *)0) 
# 92 "RTOS/Src/task_scheduler.c"
                           ;
 }
 ...
 __asm volatile("mov r0,%0 \n\t msr PSP,r0" : : "r" (OS_Control.CurrentTask->Current_PSP) );
...
# 147 "RTOS/Src/task_scheduler.c"
void MHxRTOS_Create_MainStack()
{
 OS_Control._S_MSP_Task = &_estack;
 OS_Control._E_MSP_Task = OS_Control._S_MSP_Task - 3072;
...
MHxRTOS_errorID MHxRTOS_init()
{
 MHxRTOS_errorID error = NoError ;
 ...
 strcpy (MHxRTOS_idleTask.TaskName, "idleTask");
 MHxRTOS_idleTask.priority = 255 ;
 MHxRTOS_idleTask.p_TaskEntry = MHxRTOS_IdleTask ;
 MHxRTOS_idleTask.Stack_Size = 300 ;

 error += MHxRTOS_CreateTask(&MHxRTOS_idleTask);
...
void MHxRTOS_Create_TaskStack(Task_ref* Tref)
{
# 202 "RTOS/Src/task_scheduler.c"
 ...
 *(Tref->Current_PSP) = 0x01000000;
 ...
 Tref->Current_PSP-- ;
 *(Tref->Current_PSP) = (unsigned int)Tref->p_TaskEntry ;
...
void MHxRTOS_Update_Schadule_tables()
{
 Task_ref* temp =
# 284 "RTOS/Src/task_scheduler.c" 3 4
                ((void *)0) 
# 284 "RTOS/Src/task_scheduler.c"
                     ;
 Task_ref* Ptask ;
 Task_ref* PnextTask ;
 unsigned int i = 0 ;
...
void MHxRTOS_ActivateTask (Task_ref* Tref)
{
 ...
 MHxRTOS_OS_SVC_Set(SVC_Activatetask);
}
void MHxRTOS_TerminateTask (Task_ref* Tref)
{
 Tref->TaskState = Suspend ;
 MHxRTOS_OS_SVC_Set(SVC_terminateTask);
}
void MHxRTOS_TaskWait(unsigned int NoTICKS,Task_ref* SelfTref)
{
...
void MHxRTOS_STARTOS()
{
 ...
 OS_Control.CurrentTask = &MHxRTOS_idleTask ;

 MHxRTOS_ActivateTask(&MHxRTOS_idleTask);
...
void MHxRTOS_Update_TasksWaitingTime()
{
 for (unsigned int i =0; i < OS_Control.NoOfActiveTasks ; i++ )
 {
  if (OS_Control.OSTasks[i]->TaskState == Suspend)
  {
   if (OS_Control.OSTasks[i]->TimingWaiting.Blocking == Enable)
   {
    ...
    if (OS_Control.OSTasks[i]->TimingWaiting.Ticks_Count == 1)
    {
     ...
     MHxRTOS_OS_SVC_Set(SVC_TaskWaitingTime);
    }
   }
  }
 }
...
MHxRTOS_errorID MHxRTOS_AcquireMutex(Mutex_ref* Mref , Task_ref* Tref)
{
 if(Mref->CurrentTUser == 
# 495 "RTOS/Src/task_scheduler.c" 3 4
                         ((void *)0)
# 495 "RTOS/Src/task_scheduler.c"
                             )
 {
 ...
 {
  if(Mref->NextTUser == 
# 500 "RTOS/Src/task_scheduler.c" 3 4
                       ((void *)0)
# 500 "RTOS/Src/task_scheduler.c"
                           )
  {
   Mref->NextTUser = Tref ;
...
{
 if(Mref->CurrentTUser != 
# 517 "RTOS/Src/task_scheduler.c" 3 4
                         ((void *)0)
# 517 "RTOS/Src/task_scheduler.c"
                             )
 {
  Mref->CurrentTUser = Mref->NextTUser ;
  Mref->NextTUser = 
# 520 "RTOS/Src/task_scheduler.c" 3 4
                    ((void *)0) 
# 520 "RTOS/Src/task_scheduler.c"
                         ;
