# 0 "drivers/Src/stm32f401xx_spi_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_spi_driver.c"
# 14 "drivers/Src/stm32f401xx_spi_driver.c"
...
# 15 "drivers/Src/stm32f401xx_spi_driver.c" 2
# 1 "drivers/Inc/stm32f401xx_spi_driver.h" 1
# 16 "drivers/Src/stm32f401xx_spi_driver.c" 2
# 1 "drivers/Inc/stm32f401xx.h" 1
# 17 "drivers/Src/stm32f401xx_spi_driver.c" 2
# 25 "drivers/Src/stm32f401xx_spi_driver.c"
S_SPI_Config_t * Global_SPI_Config[2] = {
# 25 "drivers/Src/stm32f401xx_spi_driver.c" 3 4
                                        ((void *)0)
# 25 "drivers/Src/stm32f401xx_spi_driver.c"
                                            , 
# 25 "drivers/Src/stm32f401xx_spi_driver.c" 3 4
...
# 45 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_Init(SPI_TypeDef * SPIx, S_SPI_Config_t * Config)
{
    ...
    {
        Global_SPI_Config[0] = Config;
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x0B));
    }
    else
    {
        Global_SPI_Config[1] = Config;
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x0C));
    }
    ...
    tmpreg_CR1 |= Config->Payload_Length;
    ...
    else if (Config->NSS == (0x00000000U))
    {
        tmpreg_CR2 |= (0x00000000U);
    }
    else
    {
    ...
    if (Config->IRQ_Enable != (uint32_t)(0))
    {
        tmpreg_CR1 |= Config->IRQ_Enable;
        if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)))
        {
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x4)) |= 1<<(35 - 32));
        }
        else
        {
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x4)) |= 1<<(36 - 32));
        }
    }
...
# 112 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_DeInit(SPI_TypeDef * SPIx)
{
    if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)))
    {
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x84)) &= ~(1<<(35 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0B));
    }
    else
    {
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x84)) &= ~(1<<(36 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0C));
    }
}
# 139 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_SendData(SPI_TypeDef * SPIx, uint16_t * pTXBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
        while (!(SPIx->SR & ((uint8_t)0x02)));
    }
    SPIx->DR = *pTXBuffer;
}
# 161 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_ReceiveData(SPI_TypeDef * SPIx, uint16_t * pRXBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
        while (!(SPIx->SR & ((uint8_t)0x01)));
    }
    *pRXBuffer = SPIx->DR;
}
# 182 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_GPIO_Set_Pins(SPI_TypeDef * SPIx)
{
    ...
    if (SPIx == ((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000)))
    {
        ...
        if (Global_SPI_Config[0]->Device_Mode == (0x1<<2))
        {
            switch (Global_SPI_Config[0]->NSS)
            {
                case (0x1<<2):

                    PConfig.GPIO_MODE = 2;
                    PConfig.GPIO_PinSpeed = 2;
                    PConfig.GPIO_PinNumber = 4;
                    PConfig.GPIO_PinPuPdControl = 2;
                    PConfig.GPIO_PinOPType = 0;
                    PConfig.GPIO_PinAltFunMode = 5;
                    MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0000)), &PConfig);
                    break;
    ...
    else
    {
        ...
        if (Global_SPI_Config[1]->Device_Mode == (0x1<<2))
        {
            switch (Global_SPI_Config[1]->NSS)
            {
                case (0x1<<2):
                    PConfig.GPIO_PinNumber = 12;
            ...
            PConfig.GPIO_PinNumber = 13;
            MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);
            PConfig.GPIO_PinNumber = 14;
            MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);
            PConfig.GPIO_PinNumber = 15;
            MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);
        }
        else
        {
...
# 289 "drivers/Src/stm32f401xx_spi_driver.c"
void MCAL_SPI_Tx_Rx(SPI_TypeDef * SPIX, uint16_t * TX_RX_pBuffer, enum SPI_PollingMechanism Polling_En)
{
    if (Polling_En == Enabled)
    {
...
# 313 "drivers/Src/stm32f401xx_spi_driver.c"
void SPI1_IRQHandler(void)
{
    struct S_IRQ_SRC irq_src;
    irq_src.TXE = ((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->SR & (1 << 1)) >> 1);
    irq_src.RXE = ((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->SR & (1 << 0)) >> 0);
    irq_src.ERRI = ((((SPI_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x3000))->SR & (1 << 4)) >> 4);
    Global_SPI_Config[0]->P_IRQ_CallBack(irq_src);
}
# 331 "drivers/Src/stm32f401xx_spi_driver.c"
void SPI2_IRQHandler(void)
{
    struct S_IRQ_SRC irq_src;
    irq_src.TXE = ((((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->SR & (1 << 1)) >> 1);
    irq_src.RXE = ((((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->SR & (1 << 0)) >> 0);
    irq_src.ERRI = ((((SPI_TypeDef *) (((uint32_t)0x40000000) + 0x3800))->SR & (1 << 4)) >> 4);
