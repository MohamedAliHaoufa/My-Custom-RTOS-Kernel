# 0 "drivers/Src/stm32f401xx_i2c_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_i2c_driver.c"
# 17 "drivers/Src/stm32f401xx_i2c_driver.c"
# 1 "drivers/Inc/stm32f401xx_i2c_driver.h" 1
# 28 "drivers/Inc/stm32f401xx_i2c_driver.h"
...
# 29 "drivers/Inc/stm32f401xx_i2c_driver.h" 2
...
# 18 "drivers/Src/stm32f401xx_i2c_driver.c" 2
# 1 "drivers/Inc/stm32f401xx_usart_driver.h" 1
# 19 "drivers/Src/stm32f401xx_i2c_driver.c" 2
# 1 "drivers/Inc/stm32f401xx_rcc_driver.h" 1
# 20 "drivers/Src/stm32f401xx_i2c_driver.c" 2
# 34 "drivers/Src/stm32f401xx_i2c_driver.c"
S_I2C_Config_t Global_I2C_Config[2];
# 50 "drivers/Src/stm32f401xx_i2c_driver.c"
void MCAL_I2C_Init(I2C_TypeDef *I2Cx, S_I2C_Config_t *I2C_Init_Struct)
{
    ...
    {
        Global_I2C_Config[0] = *I2C_Init_Struct;
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x0D));
    }
    else
    {
        Global_I2C_Config[1] = *I2C_Init_Struct;
        MCAL_RCC_Enable_Peripheral(((uint8_t)0x0E));
    }

    if (I2C_Init_Struct->I2C_Mode == 0)
    {
        ...
        if ((I2C_Init_Struct->I2C_Speed == (0x50000UL)) || (I2C_Init_Struct->I2C_Speed == (100000UL)))
        {
        ...
        {
            tempreg |= ((uint8_t)0x01);
            tempreg |= (I2C_Init_Struct->I2C_Slave_address.SecondaryAddress << (1U));
            I2Cx->OAR2 = tempreg;
        }
        tempreg = 0;
        ...
        if (I2C_Init_Struct->P_Slave_Event_CallBack != 
# 114 "drivers/Src/stm32f401xx_i2c_driver.c" 3 4
                                                      ((void *)0)
# 114 "drivers/Src/stm32f401xx_i2c_driver.c"
                                                          )
        {
            I2Cx->CR2 |= ((uint16_t)0x0400);
            I2Cx->CR2 |= ((uint16_t)0x0100);
            I2Cx->CR2 |= ((uint16_t)0x0200);
        }
        if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)))
        {
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x0)) |= 1<<(31));
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x4)) |= 1<<(32 - 32));
        }
        else
        {
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x4)) |= 1<<(33 - 32));
            ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x4)) |= 1<<(34 - 32));
        }
        I2Cx->SR1 = 0x0;
        I2Cx->SR2 = 0x0;
    }
...
void MCAL_I2C_Deinit(I2C_TypeDef *I2Cx)
{
    if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)))
    {
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x80)) &= ~(1<<(31)));
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x84)) &= ~(1<<(32 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0D));
    }
    else
    {
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x84)) &= ~(1<<(33 - 32)));
        ((*(volatile uint32_t *)(((0xE000E000UL) + 0x0100UL) + 0x84)) &= ~(1<<(34 - 32)));
        MCAL_RCC_Reset_Peripheral(((uint8_t)0x0E));
    }
}
# 172 "drivers/Src/stm32f401xx_i2c_driver.c"
void MCAL_I2C_Set_GPIO(I2C_TypeDef *I2Cx)
{
    ...
    if (I2Cx == ((I2C_TypeDef *) (((uint32_t)0x40000000) + 0x5400)))
    {
        ...
        PConfig.GPIO_MODE = 2;
        PConfig.GPIO_PinSpeed = 2;
        PConfig.GPIO_PinNumber = 6;
        PConfig.GPIO_PinPuPdControl = 0;
        PConfig.GPIO_PinOPType = 1;
        PConfig.GPIO_PinAltFunMode = 4;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);

        PConfig.GPIO_PinNumber = 7;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);
    }
    else
    {
        ...
        PConfig.GPIO_MODE = 2;
        PConfig.GPIO_PinSpeed = 2;
        PConfig.GPIO_PinNumber = 10;
        PConfig.GPIO_PinPuPdControl = 0;
        PConfig.GPIO_PinOPType = 1;
        PConfig.GPIO_PinAltFunMode = 4;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);

        PConfig.GPIO_PinNumber = 3;
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PConfig);
    }
}
# 218 "drivers/Src/stm32f401xx_i2c_driver.c"
void MCAL_I2C_Master_Tx(I2C_TypeDef * I2Cx,uint16_t SlaveAdd,uint8_t * dataout,uint32_t datalen,StopCondition Stop,Repeated_Start start)
{
  int i = 0;
...
# 244 "drivers/Src/stm32f401xx_i2c_driver.c"
 I2Cx->DR = dataout[i];
...
# 383 "drivers/Src/stm32f401xx_i2c_driver.c"
void MCAL_I2C_Master_Rx(I2C_TypeDef *I2Cx, uint16_t SlaveAdd, uint8_t *dataout, uint32_t datalen, StopCondition Stop, Repeated_Start start)
{
    uint32_t i = datalen;
...
# 428 "drivers/Src/stm32f401xx_i2c_driver.c"
void I2C_Generate_Start(I2C_TypeDef *I2Cx, Functional_State state, Repeated_Start start)
{
    if (start == Repeated) {
...
# 449 "drivers/Src/stm32f401xx_i2c_driver.c"
void I2C_ACKnowlageConfig(I2C_TypeDef *I2Cx, Functional_State NewState)
{
    if (NewState != DISABLE) {
...
# 467 "drivers/Src/stm32f401xx_i2c_driver.c"
FlagStatus I2C_Get_FlagStatus(I2C_TypeDef *I2Cx, Status flag)
{
    ...
    switch (flag) {
        case I2C_Flag_Busy:
            Flag = ((I2Cx->SR2 & ((uint16_t)0x0002)) != 0) ? Set : Reset;
            break;

        case EV5:
            Flag = ((I2Cx->SR1 & ((uint16_t)0x0001)) != 0) ? Set : Reset;
            break;

        case EV6:
            Flag = ((I2Cx->SR1 & ((uint16_t)0x0002)) != 0) ? Set : Reset;
            break;
        ...
        case EV8:
        case EV8_1:
            Flag = ((I2Cx->SR1 & ((uint16_t)0x0080)) != 0) ? Set : Reset;
            break;

        case EV7:
            Flag = ((I2Cx->SR1 & ((uint16_t)0x0040)) != 0) ? Set : Reset;
            break;
    }

    return Flag;
}
# 515 "drivers/Src/stm32f401xx_i2c_driver.c"
...
# 534 "drivers/Src/stm32f401xx_i2c_driver.c"
void I2C_Generate_Stop(I2C_TypeDef *I2Cx, Functional_State NewState)
{
    if (NewState != DISABLE) {
...
# 551 "drivers/Src/stm32f401xx_i2c_driver.c"
void MCAL_I2C_Slave_SendData(I2C_TypeDef *I2Cx, uint8_t data)
{
    I2Cx->DR = data;
}
# 564 "drivers/Src/stm32f401xx_i2c_driver.c"
uint8_t MCAL_I2C_SlaveReceiveData(I2C_TypeDef *I2Cx)
{
    return I2Cx->DR;
}
