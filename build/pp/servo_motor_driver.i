# 0 "bsp/Src/servo_motor_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "bsp/Src/servo_motor_driver.c"
# 14 "bsp/Src/servo_motor_driver.c"
...
# 15 "bsp/Src/servo_motor_driver.c" 2
# 25 "bsp/Src/servo_motor_driver.c"
void Servo1_Entry_Gate_Init(void)
{
    GPIO_PinConfig_t PinCinfg;
    PinCinfg.GPIO_PinNumber = 8;
    PinCinfg.GPIO_MODE = 1;
    PinCinfg.GPIO_PinOPType = 0;
    PinCinfg.GPIO_PinPuPdControl = 0;
    PinCinfg.GPIO_PinSpeed = 2;

    MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), &PinCinfg);
}
# 47 "bsp/Src/servo_motor_driver.c"
void Servo1_Entry_Gate(uint8 Direction)
{
    if(Direction == 0)
    {

        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), 8, 1);
        dus(500);
        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), 8, 0);
    }
    else if(Direction == 1)
    {
...
# 74 "bsp/Src/servo_motor_driver.c"
void Servo2_Exit_Gate_Init(void)
{
    GPIO_PinConfig_t PinCinfg;
    PinCinfg.GPIO_PinNumber = 9;
    PinCinfg.GPIO_MODE = 1;
    PinCinfg.GPIO_PinOPType = 0;
    PinCinfg.GPIO_PinPuPdControl = 0;
    PinCinfg.GPIO_PinSpeed = 2;
...
# 96 "bsp/Src/servo_motor_driver.c"
void Servo2_Exit_Gate(uint8 Direction)
{
    if(Direction == 0)
    {

        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), 9, 1);
        dus(500);
        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x0400)), 9, 0);
    }
    else if(Direction == 1)
    {
