...
# 100 "Inc/app_states.h"
void ST_Init_STATE(void);




void ST_Admin_STATE(void);




void ST_Idle_STATE(void);




void ST_Enter_Gate_STATE(void);




void ST_Exit_Gate_STATE(void);




void ST_Full_STATE(void);
# 16 "Src/app_states.c" 2
# 26 "Src/app_states.c"
...
void (*fp_App_State_Handler)() = ST_Init_STATE;
...
void ST_Init_STATE(void){
 ...
 fp_App_State_Handler = ST_Admin_STATE;
}
...
void ST_Admin_STATE(void){
 ...
 fp_App_State_Handler = ST_Idle_STATE;
}
...
void ST_Idle_STATE(void){
 ...
 if(Exit_Flag != 0){
  ...
  if(3 != Free_Slots){
   fp_App_State_Handler = ST_Exit_Gate_STATE;
  } else {
   Exit_Flag = 0;
   Trigger_Alarm(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)));
  }
 }
 ...
 if(Enter_Flag != 0){
  ...
  fp_App_State_Handler = ST_Enter_Gate_STATE;
 }
}
...
void ST_Enter_Gate_STATE(void){
 ...
 MCAL_USART_SendString(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), (uint8_t *)" Your Scanned ID is: ", 22);


 MCAL_USART_ReceiveData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), (uint16*)&ID, disable);


 MCAL_USART_SendData(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)), (uint16*)&ID, disable);
 ...
 fp_App_State_Handler = (Free_Slots > 0) ? ST_Idle_STATE : ST_Full_STATE;
 Print_Slots_LCD_Flag = 1;
}
...
void ST_Exit_Gate_STATE(void){
 ...
 MCAL_USART_SendString(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), (uint8_t *)" Your Scanned ID is: ", 22);


 MCAL_USART_ReceiveData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), (uint16*)&ID, disable);


 MCAL_USART_SendData(((USART_TypeDef *) (((uint32_t)0x40000000) + 0x4400)), (uint16*)&ID, disable);
...
void ST_Full_STATE(void){
 ...
 if(Enter_Flag != 0){
  Enter_Flag = 0;
  Trigger_Alarm(((USART_TypeDef *) ((((uint32_t)0x40000000) + 0x00010000) + 0x1000)));
 }
