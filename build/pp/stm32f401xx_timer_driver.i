# 0 "drivers/Src/stm32f401xx_timer_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "drivers/Src/stm32f401xx_timer_driver.c"
# 14 "drivers/Src/stm32f401xx_timer_driver.c"
# 1 "drivers/Inc/stm32f401xx_timer_driver.h" 1
# 32 "drivers/Inc/stm32f401xx_timer_driver.h"
...
# 33 "drivers/Inc/stm32f401xx_timer_driver.h" 2
...
void dms(int ms);
# 15 "drivers/Src/stm32f401xx_timer_driver.c" 2
# 32 "drivers/Src/stm32f401xx_timer_driver.c"
void Timer2_init(void)
{

    ((RCC_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x3800))->APB1ENR |= (1 << 0);


    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->PSC = 7;


    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->ARR = 0xC350;


    ((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CR1 |= (1 << 0);


    while (!((((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->SR) & (1 << 0)));
}
# 61 "drivers/Src/stm32f401xx_timer_driver.c"
void dus(int us)
{
    ...
    while (((TIM_TypeDef *) (((uint32_t)0x40000000) + 0x0000))->CNT < us);
}
# 80 "drivers/Src/stm32f401xx_timer_driver.c"
void dms(int ms)
{
    int i = 0;
    for (i = 0; i < ms; i++)
