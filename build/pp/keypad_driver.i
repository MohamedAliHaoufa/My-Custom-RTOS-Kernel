# 0 "bsp/Src/keypad_driver.c"
# 1 "/home/mohamed/Downloads/test/corrected4/makefile_rtos_proteus_half_worked//"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "bsp/Src/keypad_driver.c"
# 18 "bsp/Src/keypad_driver.c"
# 1 "bsp/Inc/keypad_driver.h" 1
# 28 "bsp/Inc/keypad_driver.h"
...
# 29 "bsp/Inc/keypad_driver.h" 2
# 79 "bsp/Inc/keypad_driver.h"
void keypad_init(void);
# 93 "bsp/Inc/keypad_driver.h"
uint8 keypad_Get_Pressed_Key(void);
# 19 "bsp/Src/keypad_driver.c" 2
# 29 "bsp/Src/keypad_driver.c"
static uint8 Keypad_Buttons[4][3] = {
    { '*' , '0' , '#' },
    { '7' , '8' , '9' },
    { '4' , '5' , '6' },
    { '1' , '2' , '3' }
...
static uint16 Keypad_ROWS_GPIO[4] = {0, 1, 3, 4};




static uint16 Keypad_COLS_GPIO[3] = {5, 6, 7};
# 61 "bsp/Src/keypad_driver.c"
void keypad_init(void) {
    GPIO_PinConfig_t Pin_Cfg;


    Pin_Cfg.GPIO_MODE = 1;
    Pin_Cfg.GPIO_PinOPType = 0;
    Pin_Cfg.GPIO_PinPuPdControl = 0;
    Pin_Cfg.GPIO_PinSpeed = 2;

    for (uint8 i = 0; i < 4; i++) {
        Pin_Cfg.GPIO_PinNumber = Keypad_ROWS_GPIO[i];
        MCAL_GPIO_Init(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), &Pin_Cfg);
        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), Keypad_ROWS_GPIO[i], 0);
    }


    Pin_Cfg.GPIO_MODE = 0;
    Pin_Cfg.GPIO_PinPuPdControl = 2;
...
uint8 keypad_Get_Pressed_Key(void) {
    ...
    for (row_index = 0; row_index < 4; row_index++) {
        ...
        MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), Keypad_ROWS_GPIO[row_index], 1);

        for (col_index = 0; col_index < 3; col_index++) {
            if (MCAL_GPIO_ReadPin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), Keypad_COLS_GPIO[col_index]) == 1) {

                while (MCAL_GPIO_ReadPin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), Keypad_COLS_GPIO[col_index]) == 1);


                return_char = Keypad_Buttons[row_index][col_index];
                MCAL_GPIO_WritePin(((GPIO_TypeDef *) ((((uint32_t)0x40000000) + 0x00020000) + 0x1000)), Keypad_ROWS_GPIO[row_index], 0);
                return return_char;
            }
        }
