...
# 15 "bsp/Src/led_driver.c" 2
# 27 "bsp/Src/led_driver.c"
void LED_Init(const LED_cfg_t *led_cfg) {

    if (
# 29 "bsp/Src/led_driver.c" 3 4
       ((void *)0) 
# 29 "bsp/Src/led_driver.c"
            != led_cfg) {
        MCAL_GPIO_Init(led_cfg->LED_Port, (GPIO_PinConfig_t*)&(led_cfg->LED_Pin));

        if (led_cfg->LED_Mode == LED_Active_High) {
            MCAL_GPIO_WritePin(led_cfg->LED_Port, led_cfg->LED_Pin.GPIO_PinNumber, 0);
        } else if (led_cfg->LED_Mode == LED_Active_Low) {
            MCAL_GPIO_WritePin(led_cfg->LED_Port, led_cfg->LED_Pin.GPIO_PinNumber, 1);
        } else {
...
# 52 "bsp/Src/led_driver.c"
void LED_TurnOn(const LED_cfg_t *led_cfg) {

    if (
# 54 "bsp/Src/led_driver.c" 3 4
       ((void *)0) 
# 54 "bsp/Src/led_driver.c"
            != led_cfg) {
        if (led_cfg->LED_Mode == LED_Active_High) {
            MCAL_GPIO_WritePin(led_cfg->LED_Port, led_cfg->LED_Pin.GPIO_PinNumber, 1);
        } else if (led_cfg->LED_Mode == LED_Active_Low) {
...
# 75 "bsp/Src/led_driver.c"
void LED_TurnOff(const LED_cfg_t *led_cfg) {

    if (
# 77 "bsp/Src/led_driver.c" 3 4
       ((void *)0) 
# 77 "bsp/Src/led_driver.c"
            != led_cfg) {
        if (led_cfg->LED_Mode == LED_Active_High) {
            MCAL_GPIO_WritePin(led_cfg->LED_Port, led_cfg->LED_Pin.GPIO_PinNumber, 0);
        } else if (led_cfg->LED_Mode == LED_Active_Low) {
...
# 98 "bsp/Src/led_driver.c"
void LED_Toggle(const LED_cfg_t *led_cfg) {

    if (
# 100 "bsp/Src/led_driver.c" 3 4
       ((void *)0) 
# 100 "bsp/Src/led_driver.c"
            != led_cfg) {
